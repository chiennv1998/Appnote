...
public class SuaGhiChu extends Activity{
	  ...
	  @Override
		...
		public boolean onOptionsItemSelected(MenuItem item) {
		    ...
		    case R.id.menu_about:
		        ...
		        AlertDialog.Builder dialog = new AlertDialog.Builder(SuaGhiChu.this);
		        dialog.setTitle("About");
		        dialog.setMessage("Hello! I'm Bao, the creator of this application. This application is created for learning." +
