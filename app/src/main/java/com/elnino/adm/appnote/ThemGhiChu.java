...
public class ThemGhiChu extends ListActivity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	    ...
	    case R.id.menu_about:
	           ...
	           AlertDialog.Builder dialog = new AlertDialog.Builder(ThemGhiChu.this);
	...
	private void createNote() {
		Intent i = new Intent(this, SuaGhiChu.class);
